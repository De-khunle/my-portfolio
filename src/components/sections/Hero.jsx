...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center pt-16 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <motion.a
                href="/Popoola_Habeeb_Software_Engineering_CV.pdf"
                download="Popoola_Habeeb_Software_Engineering_CV.pdf"
