...
const Projects = () => {
  const [activeCategory, setActiveCategory] = useState("Other-Projects");
  ...
  const categories = ["Other-Projects"];

  // const filteredProjects = activeCategory === 'All'
  const filteredProjects = activeCategory === "Other-Projects" ? projects : "";
  // const filteredProjects = activeCategory === 'All'
  //   ? projects
